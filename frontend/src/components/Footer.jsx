      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-xl font-extrabold text-white">PELTI DENPASAR</h1>
          ...
          <p className="text-sm leading-relaxed text-gray-400">
            ...
            tenis lapangan di Kota Denpasar, Bali. Kami berkomitmen meningkatkan
            kualitas atlet dan mendorong partisipasi masyarakat.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-4">
            <a
              href="#"
              className="p-2 rounded-full bg-slate-700 hover:bg-yellow-400 hover:text-black transition"
            >
              <FaFacebook size={18} />
            </a>
            <a
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-gray-400">✉️ peltidenpasar@gmail.co.id</p>
        </div>
