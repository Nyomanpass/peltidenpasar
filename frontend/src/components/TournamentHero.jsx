...
const slides = [
    {
      title: "Jadwal Turnamen PelTI",
      description: "Panggung resmi untuk membuktikan kualitas atlet, meraih poin ranking kota, dan mengikuti seleksi menuju kejuaraan provinsi.",
      image: "hero.jpg" 
    },
  ];
